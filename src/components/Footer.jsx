...
function Footer() {
  return (
    <div className="flex h-8 justify-between  bg-bottombarBg px-4 text-lg text-textColor max-sm:text-sm border border-blue-950">
      <div className="flex items-center gap-x-3">
        <a
          className="flex items-center hover:bg-bottombarHoverBg"
          href="https://github.com/Utkarsh1320/"
          target="_blank"
          rel="noreferrer"
        >
          <Chevron />
